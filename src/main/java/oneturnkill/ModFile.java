...
import oneturnkill.cards.cardvars.AbstractEasyDynamicVariable;
import oneturnkill.potions.AbstractEasyPotion;
import oneturnkill.relics.AbstractEasyRelic;
import oneturnkill.util.ProAudio;
...
public class ModFile implements
    ...
    public static final String modID = "oneturnkill";

    public static String makeID(String idText) {
        return modID + ":" + idText;
    }

    public static Color characterColor = new Color(0.96f, 0.96f, 0.86f, 1f);
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.ZASKIA_COLOR, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.ZASKIA),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.ZASKIA);
