...
import oneturnkill.util.CardArtRoller;

import static oneturnkill.ModFile.makeImagePath;
import static oneturnkill.ModFile.modID;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, CharacterFile.Enums.ZASKIA_COLOR);
    }
