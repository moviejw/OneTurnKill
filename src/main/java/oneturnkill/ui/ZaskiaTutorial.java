...
import oneturnkill.util.TexLoader;

import static oneturnkill.ModFile.makeID;
import static oneturnkill.ModFile.makeImagePath;

public class ZaskiaTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString(makeID("ZaskiaTutorial"));
    ...
    public ZaskiaTutorial() {

        this.img1 = TexLoader.getTexture(makeImagePath("ui/tutorial1.png"));
        this.img2 = TexLoader.getTexture(makeImagePath("ui/tutorial2.png"));
